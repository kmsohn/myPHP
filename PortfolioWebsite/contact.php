...
if ($validForm) {
  //send email
    ...
    $contactEmail->setSender("contact@kathymsohn.com");           //the email that is sending the form
    ...
    $clientEmail->setRecipient("ksohn@dmacc.edu");           //person receiving email
...
?>
  ...
  <body>
    ...
    <section class="socialMedia">
      <div class="row">
          <div class="col">
          <a target="_blank" title="find us on Facebook" href="http://www.facebook.com/"><img alt="" border=0></a>
          <a target="_blank" title="follow me on twitter" href="http://www.twitter.com/"><img alt="" border=0></a> 
          <a target="_blank" title="follow me on instagram" href="http://www.instagram.com/"><img alt="" border=0></a>
            </div>
      </div>
  </section>
      <section class="desktopNav">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="index.php">Jessy James Hair Salon</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
		...
		<li class="nav-item">
        <a class="nav-link" href="Styling/Style.html">Styles</a>
      </li>
         	<li class="nav-item">
...
<div class="container">
    ...
    <footer class="footer">
    <div class="container">
      <span>&copy;U Got the Look Salon </span>
    </div>
  </footer>
  </section>
  </div>
