<?php
//prevents chrome error when using the back button to return to this page
...
//connect to database
        ...
        $query = "SELECT user_name,user_password FROM user_login WHERE user_name = :user_name AND user_password = :user_password";
//prepare the query and bind parameters
        $stmt = $conn->prepare($query);
        $stmt->bindValue(':user_name', $inUsername, PDO::PARAM_STR);
        $stmt->bindValue(':user_password', $inPassword, PDO::PARAM_STR);
        $stmt->execute();
...
<div class="row">
    <div class="col-sm-12">
        <h2>Jessy James Admin System</h2>
...
<div class="row">
    <div class="col-sm-12">
            ...
            if ($_SESSION['validUser'] == "yes") {
            ?>
            <h3>Jessy James Administrator Systems</h3>
                  
		<p><a href="test.php">Display Appointments</a></p>
		<p><a href="eventsForm.php">Make an Appointment</a></p>
