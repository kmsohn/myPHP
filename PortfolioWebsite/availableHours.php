...
//get all available hoursen
$queryAllHours = 'SELECT avail_id,avail_days,slot_avail,slot_open FROM available WHERE slot_open="yes" ORDER BY avail_id ASC';
...
<div class="container">
  ...
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="availableHours.php">Week One</a></li>
    <li class="page-item"><a class="page-link" href="availableHoursWeek2.php">Week Two</a></li>
  </ul>
</nav>
    <table class='table table-striped table-dark'>
    <thead>
    <tr>
      <th scope="col">Available times for the week of Monday May 14th, 2018</th>
    </tr>
  </thead>
...
<div class="container">
    ...
    <footer class="footer">
    <div class="container">
      <span>&copy;Jessy James Hair Salon </span>
    </div>
  </footer>
  </section>
  </div>
...
<div class="collapse navbar-collapse" id="navbarNav">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="contact.php">Schedule an appointment</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="contact.php">Contact Us</a>
    </li>
