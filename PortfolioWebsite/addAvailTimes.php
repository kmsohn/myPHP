...
$queryAllHours = 'SELECT avail_id,avail_days,slot_avail,slot_open FROM available WHERE slot_open="no" ORDER BY avail_id ASC';
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="index.php">Jess James Hair Salon</a>
...
<div class="container">
  ...
  <ul class="pagination">
    ...
    <thead>
    <tr>
      <th scope="col">Available times 1st week May</th>
    </tr>
  </thead>
